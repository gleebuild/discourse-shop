...
class DiscourseShop::Admin::CouponsController < DiscourseShop::Admin::BaseController
  ...
  def create
    c = DiscourseShop::Coupon.create!(coupon_params); render_json_dump(coupon: c)
  end
  def update
    c = DiscourseShop::Coupon.find(params[:id]); c.update!(coupon_params); render_json_dump(coupon: c)
  end
  def destroy
    DiscourseShop::Coupon.find(params[:id]).destroy!; render_json_dump(success: true)
  end
  private
  def coupon_params
